  ...
  const [userChoice, setUserChoice] = useState<null|number>(null)
   return (
    <View style={styles.container}>
      ...
      <Text style={styles.ticket}>Jelenlegi jegyek: {ticket} ,,, {pcChoice}</Text>
      ...
      <View style={styles.buttongroup}>
        ...
        <TouchableOpacity style={styles.btn} onPress={() => threebutton(1)}><Text style={styles.btntext}>  Közép  </Text></TouchableOpacity>
        <TouchableOpacity style={styles.btn} onPress={() => threebutton(1)}><Text style={styles.btntext}>  Jobb  </Text></TouchableOpacity>
      </View>
